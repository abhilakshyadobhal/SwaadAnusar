            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name1"  placeholder="Enter email" name="newusername" autofocus required>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-default" name="userregister" style="background-color: green;color: white;font-family: sans-serif;">Login</button>
                </form>
            </div>
        </div>
    </div>
